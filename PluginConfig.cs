...
public class PluginConfig
{
    ...
    public static ConfigEntry<bool> ConfigRandomizer;
    ...
    public static void Init(ConfigFile configFile)
    {
        ...
        ConfigRandomizer = configFile.Bind("GameplayTweaks", "Randomizer", false, "When set to true, any entity will get its abilities swapped out for random ones, same amount, reset each fight");
